<?php
		...
		include("connection.php");
                ...
                $query_search= "SELECT * FROM `eventFU` WHERE unique_name ='".mysqli_real_escape_string($link, filter_input(INPUT_POST, 'TeamName'))."' AND event_id ='".mysqli_real_escape_string($link, filter_input(INPUT_POST, 'event_id'))."' LIMIT 1";
    		...
    		echo "<li>You've been successfully registered!</li>";
				...
				*/
				...
				require '../../ad-admin/PHPMailer/PHPMailerAutoload.php';
